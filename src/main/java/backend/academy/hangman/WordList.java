...
public class WordList {
    ...
    private static final List<Word> easyAnimals = List.of(
    ...
    private static final List<Word> mediumAnimals = List.of(
    ...
    private static final List<Word> hardAnimals = List.of(
    ...
    private static final List<Word> easyCountries = List.of(
    ...
    private static final List<Word> mediumCountries = List.of(
    ...
    private static final List<Word> hardCountries = List.of(
    ...
    private static final List<Word> easyFruits = List.of(
    ...
    private static final List<Word> mediumFruits = List.of(
    ...
    private static final List<Word> hardFruits = List.of(
    ...
    private static final List<Word> easySports = List.of(
    ...
    private static final List<Word> mediumSports = List.of(
    ...
    private static final List<Word> hardSports = List.of(
    ...
    @Getter private static final List<List<Word>> animalList = List.of(
        easyAnimals,
        mediumAnimals,
        hardAnimals);

    @Getter private static final List<List<Word>> countryList = List.of(
        easyCountries,
        mediumCountries,
        hardCountries);

    @Getter private static final List<List<Word>> fruitList = List.of(
        easyFruits,
        mediumFruits,
        hardFruits);

    @Getter private static final List<List<Word>> sportList = List.of(
        easySports,
        mediumSports,
        hardSports);

    @SuppressWarnings("MagicNumber")
    public static List<List<Word>> getRandomListWords() {
